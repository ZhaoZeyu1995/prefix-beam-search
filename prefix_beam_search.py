...
def prefix_beam_search(ctc, lm=None, k=25, alpha=0.30, beta=5, prune=0.001, alphabet=None):
    """
    ...
    def W(l): return re.findall(r'\w+[\s|>]', l)
    if not alphabet:
    ...
    for t in range(1, T):
            ...
            for c in pruned_alphabet:
                ...
                # END: STEP 4
                    ...
                    # STEP 5: Extending with any other non-blank character and LM constraints
                        ...
                        Pnb[t][l_plus] += lm_prob * ctc[t][c_ix] * \
                            (Pb[t - 1][l] + Pnb[t - 1][l])
                    else:
                        Pnb[t][l_plus] += ctc[t][c_ix] * \
                            (Pb[t - 1][l] + Pnb[t - 1][l])
                    # END: STEP 5
        ...
        A_next = Pb[t] + Pnb[t]
        def sorter(l): return A_next[l] * (len(W(l)) + 1) ** beta
